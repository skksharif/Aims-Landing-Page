          ...
          <div className="grid gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm md:text-base text-center md:text-left mb-6">
                ...
                below shows the distribution of admissions by primary diagnosis.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm md:text-base text-center md:text-left mb-6">
                ...
                their care. This chart shows the distribution of preterm babies
                by weight category.
              </p>
              <div className="w-full flex justify-center">
                <div className="w-full max-w-xs sm:max-w-md">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm md:text-base text-center md:text-left mb-6">
                Our hospital has consistently achieved high survival rates.
                This chart shows the trend of survival rates over the past
                several years.
              </p>
              <div className="w-full flex justify-center">
                <div className="w-full max-w-xs sm:max-w-lg">
                  <StatisticsChart
                    type="line"
                    title="Survival Rates (%) Over Time"
                    data={survivalData}
                    options={{
                      responsive: true,
      ...
      <section className="bg-gray-50 py-8 md:py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* KPI Cards */}
            {[
              { label: "NICU Survival Rate", value: "99%", color: "text-primary-blue" },
              { label: "PICU Survival Rate", value: "90%", color: "text-primary-green" },
              { label: "MV Survival Rate", value: "96.9%", color: "text-accent-purple" },
              { label: "Emergency Care", value: "24/7", color: "text-accent-teal" },
            ].map((item, index) => (
              <div key={index} className="card-neumorphic text-center p-4">
                <div className={`text-3xl md:text-4xl font-bold ${item.color} mb-2`}>
                  {item.value}
                </div>
                <h3 className="text-base md:text-lg font-medium">{item.label}</h3>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-xl p-6 md:p-8 lg:p-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-sm md:text-lg mb-6 md:mb-8">
                ...
                our dedication to continuous improvement in pediatric healthcare.
              </p>
              <a
                href="/contact"
